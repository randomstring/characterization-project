...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(12, Sides.LEFT, false);

    WPI_TalonFX leftFollowerID13 = setupWPI_TalonFX(13, Sides.FOLLOWER, false);
    leftFollowerID13.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(14, Sides.RIGHT, false);
    WPI_TalonFX rightFollowerID15 = setupWPI_TalonFX(15, Sides.FOLLOWER, false);    
